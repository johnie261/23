...
<?php 
			...
			$viewContuer = mysql_query("SELECT * FROM visitor_details");
      $minus = mysql_query('SELECT * FROM visitor_details WHERE ip ="41.222.15.61" ');

		?>
		<div class="text-center" style="text-align:center; padding-top:150px;">

		<span  style=" color:teal; font-size:50px; padding: 0 0px; ">Archstone Kenya<br>
       
    <p style="color:#000;"><i style="font-size: 25px; color:teal;">Total Views</i><br>
      <?php echo mysql_num_rows($viewContuer) - mysql_num_rows($minus)  ?>
      <br><i style="font-size: 25px; color:teal;">View(s)</i></p> </span>
		<div id="actual"></div>
    <br>
     <link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">
    <a href="index.php" class="btn btn-success" role="button"><b>Back to Main site</b></a>
		</div>
