...
<?php
  ...
  if(!empty($prodID)){
    $sqlSelectSpecProd = mysql_query("SELECT * FROM property WHERE id = '$prodID'") or die(mysql_error());
...
<?php
$sql = mysql_query("SELECT ID, status FROM property WHERE ID = '$prodID' AND status = 'Available' ");
...
<div class="container">
  <div class="row">
     <div class="col-lg-9"><br><br>
      <b style="color:black">ID:</b><b style="color:#377386;"> <?php echo $prodID; ?></b>
      <?php include('slider.php'); ?><br><br>
     </div>

     <div class="col-lg-3" style="padding-left:60px; padding-top:40px; font-style:normal; font-family: Helvetica;"><br>
        ...
        <p style="color:#fff; text-align:center; font-size:20px; background-color:#377386;"><?php echo $prodloc; ?></p>
         <b style="color:black">Category:</b><b style="color:#377386;"> <?php echo $prodcat; ?></b><br><br>
         <p><b style="color:black">Description:<br> </b><b style="color:#377386; font-size:13px;"><?php echo $proddesc; ?></b><br><br>
        <b>Price:</b> <br><span class="price"> <b style="color:#377386; font-size:20px;"><?php echo $prodprice; ?> <i style="color:#000; font-size:12px;"></i></b></span></b><a href="https://api.whatsapp.com/send?phone=91XXXXXXXXXX&text=urlencodedtext" class="fa fa-whatsapp" target="_blank"></a> 
...
.fa-whatsapp {
  ...
  color: white;
                  ...
                  <body>
                      <div > 
                  <button onclick="document.getElementById('id01').style.display='block'" class="btn btn-primary " style=" background-color:#377386; font-size:11px;">Request Viewing</button><br>
                ...
                <br>
                <div style="font-size:13px;color:#377386">
                  <div style="font-weight:600";>Contact Info</div> Mobile:(+254)720134987<br>(+254)788431125 <br> (+254)723912270<br>
                  Office:+254775400811 
                  <b style="font-weight:600";>Email:</b> info@archstonekenya.com<br>
                  <b style="font-weight:600";>P.O.BOX:<br></b> 13730-00800,Nairobi,Kenya</p>
                </div>
                </div>       
   </p>
