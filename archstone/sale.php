<?php include('includes/header.php'); ?>
	<body>
      ...
      <div style="width: 100%; height: 48px; border-bottom: 4px solid #377386;; text-align: center ">
        ...
        else
        {
          ...
          $result = mysql_query("SELECT * FROM property where status ='Available' and category='For Sale' ORDER BY  indexp, idexL  DESC LIMIT $page1,9 ");
                }
        ...
        $prodID = $row["ID"];
          ...
          echo '<div style="padding-top:40px;">
              ...
              <h6><b style="text-align:center; color:#377386; font-weight:bolder; font-size:20px;">'.$row['location'].'  </b><b style="float:right; color:#707070;">'.$prodID.'</b><b style="color:#707070; float:right;">ID:</b></h6>
   ...
   <div class="container">
          <?php
            ...
            $result = mysql_query("SELECT * FROM property where status ='Available' and category='For Sale'");
            ...
            ?>
            <a href="sale.php?page=<?php echo $b;?>" style="background-color:#377386; color:#fff; padding:8px; text-align:center; "><?php echo "\n\n".$b."";  ?></a> &nbsp;&nbsp;<?php
            }
