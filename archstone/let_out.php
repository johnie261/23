  ...
  <body>
    ...
    <div class="container"><br><br><br><br>
      ...
      <?php    
        ...
        else
        {
          ...
          $result = mysql_query("SELECT * FROM property where id not in('139','138','136','165') and not status ='available'  ORDER BY  indexp, idexL  DESC LIMIT $page1,9 ");
                }
        ...
        $prodID = $row["ID"];
          ...
          echo '<div style="padding-top:40px;">
            ...
            <a class="img_wrap" href="details?prodid='.$prodID.'" rel="bookmark" title="'.$row['Product'].'" target="_blank"><img  class="img-fluid img img_img" src="http://archstonekenya.com/images/fulls/'.$row['imgUrl'].'" alt="'.$row['Product'].'" title="'.$row['Product'].'" width="100%" height="250" /></a>
                    </a><b class="img_description"><br><br><br><br> <br><br><a href="let_out_details.php?prodid='.$prodID.'" class="btn btn-default " style="background-color:white; color:rgba(46, 74, 83, 0.85);" target="_blank"></i>More Details <br> </a><br><br><br><br><b class="price">Price:</b><b style="color:#000386;">'.$row['Price'].'</b></b>
   ...
   <div class="container">
          <?php
            ...
            $result = mysql_query("SELECT * FROM property where id not in('139','138','136','165') and not status ='available'");
            ...
            ?>
            <a href="let_out.php?page=<?php echo $b;?>" style="background-color:#377386; color:#fff; padding:8px; text-align:center; "><?php echo "\n\n".$b."";  ?></a> &nbsp;&nbsp;<?php
            }
