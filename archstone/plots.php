<?php include('includes/header.php'); ?>
	<body>
      ...
      <div style="width: 100%; height: 48px; border-bottom: 4px solid #377386;; text-align: center ">
        ...
        else
        {
          ...
          $result = mysql_query("SELECT * FROM holidayhome/* where status ='Available' ORDER BY  indexp, idexL  DESC LIMIT $page1,9*/ ");
                }
   ...
   <div class="container">
          <?php
            ...
            $result = mysql_query("SELECT * FROM holidayhome");
            ...
            ?>
            <a href="plots.php?page=<?php echo $b;?>" style="background-color:#377386; color:#fff; padding:8px; text-align:center; "><?php echo "\n\n".$b."";  ?></a> &nbsp;&nbsp;<?php
            }
